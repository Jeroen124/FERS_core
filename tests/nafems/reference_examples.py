...
def ss_square_plate(N=16):
    ...
    SurfaceLoad(
        ...
        polygon=[
            ...
            SurfaceLoadVertex(a, 0, 0),
            SurfaceLoadVertex(a, a, 0),
            SurfaceLoadVertex(0, a, 0),
        ],
    )
    c.add_load_case(lc)
    ...
    print(
        f"[ss-plate N={N}] w_center FERS={wc:.6e}  target={-w_target:.6e}  err={H.rel_err_pct(wc, -w_target):.2f}%"  # noqa: E501
    )
