...
membergroup3 = MemberSet(members=[rope_1])
...
nodal_load = NodalLoad(node=node3, load_case=end_load_case, magnitude=1000.0, direction=(0, 0.0, 1))


# Run analysis
file_path = os.path.join("json_input_solver", "083_Double_cantilever_rope_double_supported.json")
