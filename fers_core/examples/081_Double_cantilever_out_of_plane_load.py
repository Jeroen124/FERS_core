...
nodal_load = NodalLoad(node=node3, load_case=end_load_case, magnitude=-1000, direction=(0, 0, 1))

# Run analysis
file_path = os.path.join("json_input_solver", "081_Double_cantilever.json")
