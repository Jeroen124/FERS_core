...
result_loadcase = calculation_1.resultsbundle.loadcases["Intermediate Load"]
...
delta_analytical = -(F * L**3) / (192 * E * I)  # Max deflection
M_max_analytical = (F * L) / 8  # Max moment at intermediate node
Mz_begin_end = (F * L) / 8  # Max moment at the fixed end
