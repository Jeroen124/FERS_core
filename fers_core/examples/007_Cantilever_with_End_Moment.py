import os
from fers_core import Node, Member, FERS, Material, Section, MemberSet, NodalSupport, AnalysisOrder
...
results_end_load = calculation_1.resultsbundle.loadcases["End Load"]
