...
model.add_member_dist_load("M1", "FY", -1000, -1000)
...
print("Reaction forces and moments at nodes:")
for node_name, node in model.nodes.items():
    print(f"At node {node_name}:")
    print(f"    Reaction Force in X: {node.RxnFX}")
    print(f"    Reaction Force in Y: {node.RxnFY}")
    print(f"    Reaction Force in Z: {node.RxnFZ}")
    print(f"    Reaction Moment about X: {node.RxnMX}")
    print(f"    Reaction Moment about Y: {node.RxnMY}")
    print(f"    Reaction Moment about Z: {node.RxnMZ}")
